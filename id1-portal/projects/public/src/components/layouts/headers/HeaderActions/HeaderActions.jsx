...
import { faUserCircle, faLowVision, faHistory } from '@fortawesome/free-solid-svg-icons'
            ...
            <ul className={actionsULClassnames}>
                <li>
                    <button className="header__signInBtn" type="button" onClick={this.handleSignIn}>
                        <FontAwesomeIcon icon={faUserCircle} className="actionsHeaderIcon" />
                ...
                <li className="change-version" id="changeVision">
                    <FontAwesomeIcon className="actionsHeaderIcon lowvisionIcon" icon={faLowVision} />
                    <span onClick={() => {
...

                {
                    ...
                    <li className="old-version" id="oldVision">
                        <FontAwesomeIcon className="actionsHeaderIcon oldVersionIcon" icon={faHistory} />
                    ...
                    <li className="nav-gov-sites mt-auto d-lg-none">
                        <GovSites />
                    </li>
