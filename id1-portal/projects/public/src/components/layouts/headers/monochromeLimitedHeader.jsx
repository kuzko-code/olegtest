...
class MonochromeLimitedHeader extends Component {
    ...
    render() {
        ...
        const { translate, settings, languages, setErrorPage, pageLoaded, locateForURL, menu, loading, error, sites } = this.props;
            ...
            nav =
                <div className={isSticky ? 'header_bottom sticky-color' : 'header_bottom'} id="headerBottom">
                    <nav className={liColorBG} id="menu">
                                        ...
                                        <div>
                                            ...
                                            <div className="submenu">
                                                <ul className="submenu_list row" >
                                                    {res.nodes.map(datas =>
                                                        <li className="col-lg-4 hovergreen" key={datas.key}>
                        ...
                        <HeaderActions className="actions_header-mobile d-flex flex-column flex-grow-1 d-lg-none" includeGovSites={true} govSites={sites} isLowVisionOn={this.props.isLowVisionOn} toggleLowVision={this.props.toggleLowVision} closeDrawer={this.menuLinkClick} />
                    </nav>
                    <div className={overflowArrowBlockClassnames} id="overflovedArrowBlock">
                        <div className="m-auto" id="allItemsIconDiv">
                            <FontAwesomeIcon className={allNavItemsArrowClassnames} id="allNavItemsArrow" color="#fff" onClick={this.toggleShowAllItems} icon={['fas', "chevron-down"]} />
                        </div>
                    </div>
