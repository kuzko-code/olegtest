...
import MiddleViewNews from "../../components/NewsView/MiddleViewNews/MiddleViewNews.jsx"
import { connect } from 'react-redux'
import * as actions from '../../redux/settings/actions.js';
import { TabHeader, Pagination } from '../../components/ReExportComponents.js'
...
class NewsList extends Component {
    ...
    loadingData(resetActivePage) {
        ...
        Promise.all([getNewsList(search, rubric, tag, firstItem, itemsOnPage, language), getNewsCount(search, rubric, tag, language)]).then(response => {
            ...
            pages = Math.ceil(response[1].data.count / itemsOnPage);
