...
Select update_or_insert_tabs(
    'usefulLinks',
    '[]',
    '{"type": "array", "maxItems": 10, "items": {"type": "object","required": ["title","url"],"properties": {"title": {"type": "string", "title": "Назва", "maxLength":50},"url": {"type": "string","title": "Посилання", "pattern": "^\\https?:\/\/(www\\.)?[-a-zA-Z0-9@:%._\\+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_\\+.~#?&//=]*)"}}}}',
    '{"items": {"title": {"ui:placeholder": "Внесіть назву"},"url": {"ui:placeholder": "Внесіть посилання"}}}',
    'ua'
    );
...
Select update_or_insert_tabs(
    ...
    '[]',
    '{"type": "array", "maxItems": 10, "items": {"type": "object","required": ["title","url"],"properties": {"title": {"type": "string", "title": "Title", "maxLength":50},"url": {"type": "string","title": "Link", "pattern": "^\\https?:\/\/(www\\.)?[-a-zA-Z0-9@:%._\\+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_\\+.~#?&//=]*)"}}}}',
    '{"items": {"title": {"ui:placeholder": "Enter a title"},"url": {"ui:placeholder": "Enter the link"}}}',
    'en'
    );