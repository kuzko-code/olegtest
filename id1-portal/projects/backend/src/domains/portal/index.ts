...
export class portal_update_settings_with_validation {
  ...
  static async get_portal_update_settings(
    data: get_portal_update_settings_payload
  ) {
  ...
  static async get_portal_update_setting(
    data: get_or_delete_portal_update_setting_payload
  ) {
